...
export default function CreateCrystaPage() {
  const navigate =
    useNavigate()
  ...
  function changeEnhancerTargetType(
    ...
    setForm(
      (current) => ({
        ...
        /*
          Target lama dibuang ketika kategori target berubah
          agar relation tidak salah kategori.
        */
    ...
    <div className="mx-auto w-full max-w-[1280px] px-6 py-7 xl:px-8">
      ...
      <header className="mt-5">
        ...
        <p className="mt-2 max-w-[720px] text-sm leading-6 text-muted-foreground">
          Tambahkan Crysta baru beserta stat, source, dan hubungan
        ...
        <div className="border-t border-border p-6">
          ...
          {isEnhancer && (
            <DataSection
              ...
              description="Tentukan jenis Crysta yang dapat menggunakan Enhancer ini."
            >
              <div className="grid grid-cols-2 gap-5">
                <Field>
                  <FieldLabel required>
                  ...
                  <p className="mt-2 text-xs leading-5 text-muted-foreground">
                    Menentukan Enhancer ini digunakan untuk Normal, Weapon,
                    Armor, Additional, atau Special Crysta.
                  </p>
                </Field>
          ...
          {isEnhancer && (
            <DataSection
              title="Upgrade For"
              description="Pilih Crysta spesifik yang dapat di-upgrade menggunakan Enhancer ini."
              action={
                <Button
                  type="button"
                  variant="outline"
            ...
            >
              {!form.enhancerTargetType ? (
                <EmptyState
                  ...
                  description="Pilih jenis Crysta terlebih dahulu sebelum menambahkan target upgrade."
                />
              ) : form.upgradeFor
                  .length > 0 ? (
                <div className="space-y-3">
        ...
        <div className="flex items-center justify-between gap-8 border-t border-border bg-muted/20 px-6 py-5">
          <div>
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              Simpan sebagai Draft atau langsung publish ke database Aoi.
            </p>
          </div>
