...
export default function CreateBgmPage() {
  const navigate =
    useNavigate()
    ...
    <div className="mx-auto w-full max-w-[1280px] px-6 py-7 xl:px-8">
      ...
      <header className="mt-5">
        ...
        <p className="mt-2 max-w-[760px] text-sm leading-6 text-muted-foreground">
          Tambahkan informasi, cover, dan file audio untuk BGM baru.
        </p>
      </header>
            ...
            <div className="grid grid-cols-1 gap-5">
              ...
              <div className="border-t border-border pt-4">
                <p className="text-xs leading-5 text-muted-foreground">
                  Cover dapat digunakan untuk membantu mengenali lokasi
                  atau suasana yang direpresentasikan oleh BGM.
                </p>
              </div>
            </div>
