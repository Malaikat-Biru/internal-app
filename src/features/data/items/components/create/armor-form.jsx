...
export default function ArmorForm({
  ...
  function handleAppearanceSelect(
    gender,
    variant,
    event,
  ) {
  ...
  return (
    <div className="border-t border-border p-6">
      ...
      <SectionTitle
        number="02"
        title="Armor Data"
        description="Kelola appearance armor, base data, dan seluruh versi acquisition."
      />
      ...
      <div className="mt-7">
        <div>
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            Preview armor berdasarkan gender dan remodel. Semua gambar bersifat optional.
          </p>
        </div>
      ...
      <div className="mt-8 border-t border-border pt-6">
        <div>
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            Tambahkan versi armor yang tersedia.
          </p>
        </div>
        ...
        <div className="mt-4 grid grid-cols-3 gap-3">
          ...
          <VersionButton
            ...
            description="Armor yang dibuat melalui NPC Blacksmith."
            active={
              Boolean(
                npcCraftVersion,
              )
          ...
          <VersionButton
            ...
            description="Armor yang dapat dibuat melalui Player Smith."
            active={
              Boolean(
                playerCraftVersion,
              )
        ...
        {versions.length ===
          ...
          <div className="mt-5 flex min-h-[90px] items-center justify-center rounded-xl border border-dashed border-border bg-muted/[0.06] px-6">
            <p className="text-xs text-muted-foreground">
              Tambahkan minimal satu versi untuk mulai mengisi data armor.
            </p>
          </div>
        )}
      </div>
      ...
      {obtainedVersion && (
        <div className="mt-8">
          <VersionSectionHeader
            ...
            label="OBTAINED"
            title="Obtained Version"
            description="Data armor yang diperoleh dari drop, exchange, reward, atau sumber non-craft lainnya."
          />
      ...
      {npcCraftVersion && (
        ...
        >
          <VersionSectionHeader
            ...
            label="NPC CRAFT"
            title="NPC Craft Version"
            description="Data armor hasil craft melalui NPC Blacksmith."
          />
      ...
      {playerCraftVersion && (
        ...
        >
          <VersionSectionHeader
            ...
            label="PLAYER CRAFT"
            title="Player Craft Version"
            description="Data armor yang dibuat melalui Player Smith dan menggunakan Base Potential."
          />
...
/* -------------------------------------------------------------------------- */
/* NORMAL VERSION FIELDS                                                      */
/* -------------------------------------------------------------------------- */

function ArmorVersionFields({
  version,
    ...
    <div>
                  ...
                  <div className="grid grid-cols-[280px_minmax(0,1fr)_260px] gap-5">
                    <Field>
                      ...
                      <SelectMenu
                        ...
                        options={
                          armorConditionOptions
                        }
                        placeholder="Select armor condition"
                        onChange={(
                          value,
                        ) =>
                          updateConditionalStat(
      ...
      {isObtained && (
        <div className="mt-7 border-t border-border pt-6">
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            Tambahkan semua cara yang dapat digunakan untuk mendapatkan versi armor ini.
          </p>
          ...
          <div className="mt-4 grid grid-cols-3 gap-3">
            ...
            <AddSourceButton
              icon={Award}
              title="Reward"
              description="Quest, event, login, emblem, atau reward lainnya."
              onClick={() =>
                addAcquisitionSource(
                  version,
                  "REWARD",
      ...
      <div className="mt-7 border-t border-border pt-6">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              Material dan requirement untuk membuat armor melalui Smith Skill.
            </p>
          </div>
        </div>
...
function AppearanceGroupHeader({
  icon: Icon,
  title,
}) {
  return (
...
function AppearanceUpload({
  ...
  return (
    <div>
      ...
      {!value ? (
        <label className="group flex aspect-[4/5] cursor-pointer flex-col items-center justify-center rounded-xl border border-dashed border-border bg-muted/[0.06] px-4 text-center transition-colors hover:border-primary/30 hover:bg-primary/[0.02]">
        ...
        <div className="overflow-hidden rounded-xl border border-border bg-muted/[0.05]">
          <div className="relative aspect-[4/5] overflow-hidden">
            ...
            <button
              ...
              className="absolute right-2 top-2 flex size-8 cursor-pointer items-center justify-center rounded-lg bg-black/60 text-white transition-colors hover:bg-black/75"
            >
