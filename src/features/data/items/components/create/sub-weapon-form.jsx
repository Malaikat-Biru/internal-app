...
const subWeaponTypeOptions = [
  ...
  {
    value: "NINJUTSU_SCROLL",
    label: "Ninjutsu Scroll",
  },
]
...
function createBaseVersion() {
  return {
    ...
    scrollMpCostReduction: "",
    scrollCastTimeReduction: "",
...
export default function SubWeaponForm({
  data,
  setForm,
  itemOptions = [],
  ...
  return (
    <div className="border-t border-border p-6">
      ...
      <SectionTitle
        number="02"
        title="Sub-Weapon Data"
        description="Tentukan jenis sub-weapon, rekomendasi pairing, dan versi item yang tersedia."
      />
      ...
      <div className="mt-6 max-w-[420px]">
        <Field>
          ...
          <SelectMenu
            ...
            options={
              subWeaponTypeOptions
            }
            placeholder="Select sub-weapon type"
            onChange={(
              value,
            ) =>
              updateSubWeaponField(
      ...
      <div className="mt-7 border-t border-border pt-6">
        <div className="flex items-start justify-between gap-6">
          <div>
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              Tambahkan rekomendasi main weapon yang cocok menggunakan sub-weapon ini.
            </p>
          </div>
        ...
        0 ? (
                  ...
                  <div className="grid grid-cols-[minmax(0,1fr)_280px] gap-5">
                    <Field>
                      ...
                      <SelectMenu
                        ...
                        placeholder="Select main weapon"
                        onChange={(
                          value,
                        ) =>
                          updatePairing(
                    ...
                    <Field>
                      ...
                      <SelectMenu
                        ...
                        placeholder="Select pairing level"
                        onChange={(
                          value,
                        ) =>
                          updatePairing(
                  ...
                  <div className="mt-4">
                    <Field>
                      ...
                      <textarea
                        ...
                        rows={3}
                        maxLength={500}
                        placeholder="Example: Sangat cocok untuk build tank karena memberikan akses ke Shield Skills dan meningkatkan survivability."
          ...
          <EmptyInline text="No main weapon pairing added." />
        )}
      </div>
      ...
      <div className="mt-7 border-t border-border pt-6">
        <div>
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            Tambahkan versi yang diperoleh dari game atau versi NPC Craft.
          </p>
        </div>
        ...
        <div className="mt-4 grid max-w-[760px] grid-cols-2 gap-3">
          <VersionButton
            ...
            description="Drop, exchange, reward, atau sumber non-craft lainnya."
            active={
              Boolean(
                obtainedVersion,
              )
          ...
          <VersionButton
            ...
            description="Sub-weapon yang dibuat melalui NPC Blacksmith."
            active={
              Boolean(
                npcCraftVersion,
              )
        ...
        {versions.length ===
          ...
          <div className="mt-5 flex min-h-[90px] items-center justify-center rounded-xl border border-dashed border-border bg-muted/[0.06] px-6">
            <p className="text-xs text-muted-foreground">
              Tambahkan minimal satu versi untuk mulai mengisi data sub-weapon.
            </p>
          </div>
        )}
      </div>
      ...
      {obtainedVersion && (
        <div className="mt-8">
          <VersionSectionHeader
            ...
            label="OBTAINED"
            title="Obtained Version"
            description="Data sub-weapon yang diperoleh melalui drop, exchange, reward, atau sumber non-craft lainnya."
          />

          <div className="mt-5 border-l-2 border-primary/20 pl-6">
            <SubWeaponVersionFields
              subWeaponType={
                data?.type ||
                ""
              }
      ...
      {npcCraftVersion && (
        ...
        >
          <VersionSectionHeader
            ...
            label="NPC CRAFT"
            title="NPC Craft Version"
            description="Data sub-weapon hasil craft melalui NPC Blacksmith."
          />
...
function SubWeaponVersionFields({
  subWeaponType,
  version,
  ...
  return (
    <div>
      ...
      <div>
        ...
        {!subWeaponType && (
          <div className="mt-4 flex min-h-[70px] items-center rounded-xl border border-dashed border-border bg-muted/[0.05] px-4">
            <p className="text-xs text-muted-foreground">
              Select Sub-Weapon Type terlebih dahulu untuk menampilkan base attribute.
            </p>
          </div>
        )}
        ...
        {subWeaponType ===
          "ARROW" && (
          <div className="mt-4 grid max-w-[760px] grid-cols-2 gap-5">
            <NumberField
              label="Base ATK"
              required
              value={
          ...
          <div className="mt-4 grid grid-cols-3 gap-5">
            ...
            <Field>
              ...
              <input
                ...
                step="0.1"
                value={
                  version.scrollCastTimeReduction
                }
                onChange={(
                  event,
                ) =>
              ...
              (
                ...
                >
                  ...
                  <input
                    ...
                    placeholder="Example: Guard Power"
                    className={inputClass()}
                  />
      ...
      {isObtained && (
        <div className="mt-7 border-t border-border pt-6">
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            Tambahkan semua cara yang dapat digunakan untuk mendapatkan versi sub-weapon ini.
          </p>
...
function VersionButton({
  ...
  return (
    <div
      className={[
        "flex min-h-[92px] items-center gap-3 rounded-xl border px-4 py-3.5 transition-colors",
    ...
    >
      ...
      {active ? (
        <button
          ...
          className="flex size-8 shrink-0 cursor-pointer items-center justify-center rounded-lg text-muted-foreground transition-colors hover:bg-destructive/10 hover:text-destructive"
        >
          <X className="size-4" />
        </button>
      ) : (
        <button
          ...
          className="flex size-8 shrink-0 cursor-pointer items-center justify-center rounded-lg bg-muted text-muted-foreground transition-colors hover:bg-primary/10 hover:text-primary"
        >
          <Plus className="size-4" />
        </button>
      )}
