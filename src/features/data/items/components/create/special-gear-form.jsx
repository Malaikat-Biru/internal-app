...
const conditionOptions = [
  {
    value: "WITH_ONE_HANDED_SWORD",
    label: "With One-Handed Sword",
  },
  {
    value: "WITH_TWO_HANDED_SWORD",
    label: "With Two-Handed Sword",
  },
  {
    value: "WITH_BOW",
    label: "With Bow",
  ...
  {
    value: "WITH_MAGIC_DEVICE_SUB",
    label: "With Magic Device as Sub",
  },
  {
...
export default function SpecialGearForm({
  data,
  setForm,
  itemOptions = [],
  ...
  function updateSpecialGearField(
    field,
    value,
  ) {
    setForm(
  ...
  return (
    <div className="border-t border-border p-6">
      ...
      <SectionTitle
        number="02"
        title="Special Gear Data"
        description="Kelola Base DEF, stat, dan versi acquisition untuk Special Gear."
      />
      ...
      <div className="mt-7">
        <div>
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            Tambahkan versi Special Gear sesuai cara item tersedia di dalam game.
          </p>
        </div>
        ...
        <div className="mt-4 grid max-w-[760px] grid-cols-2 gap-3">
          ...
          <VersionButton
            ...
            description="Special Gear yang dibuat melalui NPC Blacksmith."
            active={
              Boolean(
                npcCraftVersion,
              )
        ...
        {versions.length ===
          ...
          <div className="mt-5 flex min-h-[90px] items-center justify-center rounded-xl border border-dashed border-border bg-muted/[0.06] px-6">
            <p className="text-xs text-muted-foreground">
              Tambahkan minimal satu versi untuk mulai mengisi data Special Gear.
            </p>
          </div>
        )}
      </div>
      ...
      {obtainedVersion && (
        <div className="mt-8">
          <VersionSectionHeader
            ...
            label="OBTAINED"
            title="Obtained Version"
            description="Data Special Gear yang diperoleh melalui drop, exchange, reward, atau sumber non-craft lainnya."
          />

          <div className="mt-5 border-l-2 border-primary/20 pl-6">
            <SpecialGearVersionFields
              version={
                obtainedVersion
              }
              monsterOptions={
      ...
      {npcCraftVersion && (
        ...
        >
          <VersionSectionHeader
            ...
            label="NPC CRAFT"
            title="NPC Craft Version"
            description="Data Special Gear hasil craft melalui NPC Blacksmith."
          />
...
function SpecialGearVersionFields({
  version,
    ...
    <div>
      ...
      {isObtained && (
        <div className="mt-7 border-t border-border pt-6">
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            Tambahkan semua cara yang dapat digunakan untuk mendapatkan Special Gear ini.
          </p>
    ...
    <div className="mt-7 border-t border-border pt-6">
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            Material dan biaya yang diperlukan untuk craft Special Gear melalui NPC Blacksmith.
          </p>
        </div>
      </div>
