...
export default function AdditionalForm({
  ...
  return (
    <div className="border-t border-border p-6">
      ...
      <SectionTitle
        number="02"
        title="Additional Gear Data"
        description="Kelola Base DEF, stat, dan seluruh versi acquisition Additional Gear."
      />
      ...
      <div className="mt-7">
        <div>
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            Tambahkan versi Additional Gear sesuai cara item tersedia.
          </p>
        </div>
        ...
        <div className="mt-4 grid max-w-[760px] grid-cols-2 gap-3">
          ...
          <VersionButton
            ...
            description="Additional Gear yang dibuat melalui NPC Blacksmith."
            active={
              Boolean(
                npcCraftVersion,
              )
        ...
        {versions.length ===
          ...
          <div className="mt-5 flex min-h-[90px] items-center justify-center rounded-xl border border-dashed border-border bg-muted/[0.06] px-6">
            <p className="text-xs text-muted-foreground">
              Tambahkan minimal satu versi untuk mulai mengisi data Additional Gear.
            </p>
          </div>
        )}
      </div>
      ...
      {obtainedVersion && (
        <div className="mt-8">
          <VersionSectionHeader
            ...
            label="OBTAINED"
            title="Obtained Version"
            description="Data Additional Gear yang diperoleh melalui monster drop, exchange, reward, atau sumber non-craft lainnya."
          />
      ...
      {npcCraftVersion && (
        ...
        >
          <VersionSectionHeader
            ...
            label="NPC CRAFT"
            title="NPC Craft Version"
            description="Data Additional Gear hasil craft melalui NPC Blacksmith."
          />
...
function AdditionalVersionFields({
  version,
    ...
    <div>
      ...
      {isObtained && (
        <div className="mt-7 border-t border-border pt-6">
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            Tambahkan semua cara yang dapat digunakan untuk mendapatkan Additional Gear ini.
          </p>
    ...
    <div className="mt-7 border-t border-border pt-6">
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            Material dan biaya craft melalui NPC Blacksmith.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-3 gap-5">
          ...
          <Field>
            ...
            <input
              ...
              placeholder="Example: Event Points"
              className={inputClass()}
            />
          </Field>
        ...
        <div className="grid grid-cols-[280px_minmax(0,1fr)_180px] gap-5">
          ...
          <Field>
            ...
            <input
              ...
              placeholder="Example: Event Reward"
              className={inputClass()}
            />
          </Field>
  ...
  return (
    ...
    >
      <button
        ...
        className={[
          "flex h-11 w-full cursor-pointer items-center gap-3 rounded-lg border border-border bg-muted/20 px-3.5 text-left",
